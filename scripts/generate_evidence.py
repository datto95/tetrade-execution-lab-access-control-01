...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate and validate evidence for access-control-01")
    ...
    evidence = {
        ...
        "assertions": {
            "exploitConfirmed": "testUnauthorizedSweepDrainsVulnerableTreasury" in output,
            "fixConfirmed": "testUnauthorizedSweepFailsAgainstFixedTreasury" in output,
            "negativeControlConfirmed": "testNegativeControlNoFundsNoSignal" in output,
        },
